...
delete from public.labour_teams
where name not in (
  'Electricians',
  'POP artists',
  'Wall artists',
...
values
  ...
  ('Carpenters', 5),
  ('Plumbers', 6),
  ('Tiles and stone masons', 7),
  ('Marble polishers', 8),
  ('Texture painters', 9),
  ('AC installers', 10),
  ('Smart home technicians', 11),
  ('CCTV installers', 12),
  ('Lining Works', 13),
  ('Fabricators', 14),
  ('Waterproofing teams', 15),
  ('Wooden flooring installers', 16),
  ('Epoxy flooring teams', 17),
  ('Core cutting workers', 18),
  ('Pest control technicians', 19),
  ('Solar panel installers', 20)
